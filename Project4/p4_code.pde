...
void cube_four_walls()
{
  ...
  edges_shader.set ("cx", cx);
  edges_shader.set ("cy", cy);
  ...
  for (int i = 0; i < 40; i++) {
    for (int j= 0; j < 40; j++) {
        beginShape();
        vertex(-100 + (i * 200.0 / div), -100 + (j * 200.0 / div), 0, i / div, j / div);
        vertex(-100 + ((i + 1) * 200.0 / div), -100 + (j * 200.0 / div), 0, (i + 1) / div, j / div);
        vertex(-100 + ((i + 1) * 200.0 / div), -100 + ((j + 1) * 200.0 / div), 0, (i + 1) / div, (j + 1) / div);
        vertex(-100 + (i * 200.0 / div), -100 + ((j + 1) * 200.0 / div), 0, i / div, (j + 1) / div);
        endShape();
    }
  }
  popMatrix();
